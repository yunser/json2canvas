const { NodeCanvas } = require('../src')

// let nodeCanvas = new NodeCanvas({})
// nodeCanvas.render(root)
// nodeCanvas.exportPng('res/aa.png')
...
async function make() {
    ...
    await canvas.render(stdUi)
    await canvas.exportPng('res/ui.png')
}
